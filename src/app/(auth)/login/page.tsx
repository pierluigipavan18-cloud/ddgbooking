      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg shadow-blue-100/50 p-8 space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border-2 border-slate-200 rounded-xl hover:bg-slate-50 transition-colors font-medium text-slate-700"
          >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-white px-4 text-slate-400">oppure</span>
            </div>
          </div>
